...
import jcj.Jcj;
	...
	public class FenChoixAdversaire2 extends Stage {
		...
		public FenChoixAdversaire2() {
			this.setTitle("Puissance 4: Choix adversaire");
		...
		private void jouer1() {
	        Jcj puissance4 = new Jcj(false);
	        this.close();
	        puissance4.show();
		}
		private void jouer2() {
			 Jcia puissance4 = new Jcia(false);
		     this.close();
		     puissance4.show();
		}
